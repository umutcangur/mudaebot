        ...
        if waifu.is_claimed:
            ...
            if ((user != self.user.name) and Config.SnipeKak) or user == self.user.name:
                if user == self.user.name:
                    await asyncio.sleep(Config.DelayKakSelf)
                elif ((user != self.user.name) and Config.SnipeKak):
            ...
            if ((user != self.user.name) and Config.Snipe) or user == self.user.name or waifu.name in Config.Wishlist:
                if user == self.user.name or waifu.name in Config.Wishlist:
                    await asyncio.sleep(Config.DelaySelf)
                elif ((user != self.user.name) and Config.Snipe):
